...
my $VersionStr= '28. Mai 2014 v0.31';

#CAREFULL: in Data Display version is not double checked!
my @SupportedBGCLayoutVersions= ( '30' ); #layout versions supported by o32BGCTool, used in ExecuteHeader()
...
my @FirmwareVersionList= ( 'v0.31','v0.29','v0.28','v0.25e','v0.24','v0.15','v0.14' ); #versions available in the flash tab selector
...
my $CMD_g_PARAMETER_ZAHL= 104; #98;
