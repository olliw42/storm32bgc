...
my $VersionStr= '12. Apr. 2015 v2.03';
...
my @FirmwareVersionList=  ( 'v2.03 NT','v2.01 NT','v0.96','v0.96 NT' ); #versions available in the flash tab selector
my @FirmwareVReplaceList= ( 'v203_nt','v201_nt','v096','v096_nt' ); #versions available in the flash tab selector
