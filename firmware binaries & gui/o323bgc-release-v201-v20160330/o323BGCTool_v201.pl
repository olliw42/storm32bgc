...
my $VersionStr= '30. Mar. 2015 v2.01';
...
my @FirmwareVersionList=  ( 'v2.01 NT','v0.96','v0.96 NT' ); #versions available in the flash tab selector
my @FirmwareVReplaceList= ( 'v201_nt','v096','v096_nt' ); #versions available in the flash tab selector
...
"When you're updating from v0.96 nt, v0.96, or v2.00, then you just need to flash the new firmware. ".
"All settings, including the scripts and calibration data, are copied over.

For older versions, it depends. Assume that this firmware will reset all parameters, scripts and calibration settings when flashed. ".
