...
my $VersionStr= '18. Mai 2014 v0.29';
...
my @FirmwareVersionList= ( 'v0.29','v0.28','v0.25e','v0.24','v0.15','v0.14' ); #versions available in the flash tab selector
...
sub m_mav_Window_Terminate{ $w_Mavlink->Hide(); 1; }
