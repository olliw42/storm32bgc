...
my $VersionStr= '6. June 2015 v0.79';
...
my @FirmwareVersionList= ( 'v0.79','v0.70','v0.68','v0.56' ); #versions available in the flash tab selector
...
#XX      $result .= ' @ HIGH ADR = on-board IMU'; }else{ $result .= ' @ LOW ADR = ext. IMU'; }
...
#XX  -text=> 'I2C Errors', -pos=> [$xpos+120,$ypos],
  -text=> 'I2C Errors', -pos=> [$xpos+240-30,$ypos],
  -background=>$ddBackgroundColor,
  -foreground=> [255,255,255],
);
...
LEVELERROR:
  $w_ConfigureGimbal->configuregimbal_WelcomeText2->Text(
    $w_ConfigureGimbal->configuregimbal_WelcomeText2->Text(). "\r\n". "\r\n".
    'The gimbal could not level with a certain time, and abborted!' . "\r\n". "\r\n".
    'Press >Cancel<.' );
WIKILINK:
