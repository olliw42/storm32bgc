...
my $VersionStr= '28. Mar. 2015 v2.00';
...
my @FirmwareVersionList=  ( 'v2.00 NT','v0.96','v0.96 NT' ); #versions available in the flash tab selector
my @FirmwareVReplaceList= ( 'v200_nt','v096','v096_nt' ); #versions available in the flash tab selector
...
"When you're updating from v0.96 nt, or v0.96, then you just need to flash the new firmware. ".
