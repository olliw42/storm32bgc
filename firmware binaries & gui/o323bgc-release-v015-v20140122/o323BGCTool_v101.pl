...
my $VersionStr= '22. Jan. 2014 v1.01';
...
my @STorM32BGCBoardList= (
{
  ...
  name => 'STorM32 BGC v0.17 w F103RB',
  uc => 'F103RB',
  hexfile => 'storm32bgc_v017_f103rb',
}
);

my @FirmwareVersionList= ( 'v0.15','v0.14' ); #versions available in the flash tab selector
...
my @ImuStatusColors= ( [255,50,50], [0,255,0], [128,128,128]); #grün, rot, grau
