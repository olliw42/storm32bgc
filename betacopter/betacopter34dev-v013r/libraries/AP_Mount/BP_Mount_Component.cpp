...
void BP_Mount_Component::update()
{
    ...
    switch (mount_mode) {
        ...
        case MAV_MOUNT_MODE_RC_TARGETING:
            ...
            if (BP_Component_get_mount_rctargettype() == bprctarget_radionin){
...
{
    return BP_Component_get_mount_haspancontrol();
}
...
{
    BP_Component_set_mount_control_rad(pitch_rad, roll_rad, yaw_rad);
...
{
    BP_Component_set_mount_control_pwm(pitch_pwm, roll_pwm, yaw_pwm);
//BP_Component_uart_write(" SEND ");
}
