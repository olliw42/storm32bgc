...
//OW
//#define THISFIRMWARE "APM:Copter V3.4-dev"  //of  16-08-03
#define THISFIRMWARE "BetaCopter V3.4-dev 015"
//OWEND
...
/*
v0.14:
 - attitude angle conversion now p:+1,r:-1,y:-1, instead of p:-1,r:+1,y:-1 as required by RC Targeting
...
=>git v014-02
 - redone attitude angle conversion change, since it was wrong
