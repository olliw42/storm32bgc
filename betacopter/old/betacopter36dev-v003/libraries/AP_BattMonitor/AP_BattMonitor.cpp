...
const AP_Param::GroupInfo AP_BattMonitor::var_info[] = {
    ...
    // @Values: 0:Disabled,3:Analog Voltage Only,4:Analog Voltage and Current,5:Solo,6:Bebop,7:SMBus-Maxell,8:UAVCAN-CircuitStatus,9:UAVCAN-BatteryInfo
    // @User: Standard
    ...
    // @Description: Battery serial number, automatically filled in for SMBus batteries, otherwise will be -1. With UAVCAN it is the circuit_id or battery_id depending on the selected type of message.
    // @User: Advanced
