...
public:
    ...
    uint8_t register_mag_listener(AP_Compass_Backend* new_listener, uint8_t preferred_channel); //OW ??? This is not used ?
...
//OW
    ...
    void storm32_nodespecific_send(uint8_t* payload, uint8_t payload_len);
//OWEND
